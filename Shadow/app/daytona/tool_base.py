...
if daytona_config.api_key:
    ...
    logger.warning("Daytona client in tool_base not initialized (missing API key)")
...
class SandboxToolsBase(BaseTool):
    ...
    async def _ensure_sandbox(self) -> Sandbox:
        ...
        if not daytona:
            raise ValueError("Daytona is not initialized. Please configure daytona_api_key in config.toml.")
